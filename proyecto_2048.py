...
def main():
    ...
    #Ajustar el tama�o de las imagenes
    ...
    #Creo las primeras posiciones aleatorias para poner los primeros dos n�meros inicales
    ...
    while True:
        ...
        #Creo un cuadrado del tama�o de la cuadricula grande         
        ...
        # Imprimos los n�meros en la cuadricula
